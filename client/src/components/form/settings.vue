...
<i18n lang="json5">
{
  "en": {
    ...
    "webFormsSetting": {
      // Title of a section on Forms settings page, that allows users to opt-in for AGR Web Forms
      "webForms": "Web Forms",
      ...
      // Success message when AGR Web Forms is selected as web form technology. {formName} is replaced with the name of the Form
      "owfSelected": "You’re now using AGR Web Forms to fill out, preview and edit your “{formName}” form."
    }
  }
}
</i18n>
...
<i18n>
{
  ...
  "de": {
    ...
    "webFormsSetting": {
      ...
      "owfSelected": "Sie verwenden jetzt AGR Web Forms, um Ihr Formular \"{formName}“ auszufüllen, in der Vorschau anzuzeigen und zu bearbeiten."
    }
  },
  "es": {
    "state": {
    ...
    "webFormsSetting": {
      ...
      "owfSelected": "Ahora estás utilizando AGR Web Forms para rellenar, previsualizar y editar tu formulario \"{formName}\"."
    }
  },
  "fr": {
    "state": {
    ...
    "webFormsSetting": {
      ...
      "owfSelected": "Vous utilisez maintenant AGR Web Forms pour remplir, prévisualiser et éditer votre formulaire \"{formName}\"."
    }
  },
  "id": {
    "state": {
  ...
  "it": {
    ...
    "webFormsSetting": {
      ...
      "owfSelected": "Ora stai utilizzando AGR Web Forms per compilare, visualizzare in anteprima e modificare il tuo formulario “{formName}\"."
    }
  },
  "ja": {
    "state": {
