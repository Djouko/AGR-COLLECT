...
<i18n lang="json5">
{
  "en": {
    "disabled": {
      ...
      "notOpen": "In this version of AGR-Collect, preview is only available for Forms in the Open state."
    }
  }
}
</i18n>
...
<i18n>
{
  "cs": {
    "disabled": {
      ...
      "notOpen": "V této verzi AGR-Collect je náhled k dispozici pouze pro formuláře v otevřeném stavu."
    }
  },
  "de": {
    "disabled": {
      ...
      "notOpen": "In dieser Version von AGR-Collect steht die Vorschau nur für Formule im Zustand \"Offen\" zur Verfügung."
    }
  },
  "es": {
    "disabled": {
      ...
      "notOpen": "En esta versión de AGR-Collect, la vista previa solo está disponible para formularios en estado abierto."
    }
  },
  "fr": {
    "disabled": {
      "processing": "L'aperçu n'a pas fini d'être exécuté pour ce formulaire. Veuillez rafraîchir plus tard et réessayer.",
      "notOpen": "Dans cette version d'AGR-Collect, l'aperçu n'est disponible que pour les formulaires dont l'état est ouvert."
    }
  },
  "id": {
    "disabled": {
      "processing": "Pratinjau untuk formulir ini masih dalam proses pengerjaan. Silakan muat ulang dan coba lagi nanti.",
      "notOpen": "Pada versi AGR-Collect ini, pratinjau hanya tersedia untuk formulir dalam kondisi terbuka."
    }
  },
  "it": {
    "disabled": {
      "processing": "L'anteprima non ha terminato l'elaborazione per questo formulario. Per favore riaggiorna più tardi e riprova.",
      "notOpen": "In questa versione di AGR-Collect, l'anteprima è disponibile solo per i formulari nello stato aperto."
    }
  },
  "ja": {
    "disabled": {
      "processing": "このフォームのプレビュー処理が終了していません。後ほどページを更新し、もう一度試して下さい。",
      "notOpen": "このバージョンのAGR-Collectでは、プレビューは、公開状態のフォームでのみ利用可能です。"
    }
  },
  "pt": {
    "disabled": {
      ...
      "notOpen": "Nessa versão do AGR-Collect, a pré-visualização está disponível apenas para formulários com status aberto."
    }
  },
  "sw": {
    "disabled": {
      "processing": "Onyesho la kuchungulia halijamaliza kuchakata Fomu hii. Tafadhali onyesha upya baadaye na ujaribu tena.",
      "notOpen": "Katika toleo hili la AGR-Collect, onyesho la kukagua linapatikana kwa Fomu zilizo katika \"OPEN STATE\""
    }
  },
  "zh": {
    "disabled": {
      "processing": "此表单的预览功能尚未处理完成，请稍后刷新重试。",
      "notOpen": "此版本AGR-Collect中，预览功能仅对“开放”状态的表单开放。"
    }
  },
  "zh-Hant": {
    "disabled": {
      "processing": "預覽尚未完成此表單的處理。請稍後重新載入並重試。",
      "notOpen": "在此版本的 AGR-Collect 中，預覽僅適用於「開啟」狀態的表單。"
    }
  }
}
</i18n>
