      ...
      <label>
        ...
        <i18n-t keypath="enabled.true[0].full">
          ...
          <template #termsOfService>
            <a href="https://agr-collect.local/tos" target="_blank">{{ $t('enabled.true[0].termsOfService') }}</a>
          </template>
          <template #privacyPolicy>
            <a href="https://agr-collect.local/privacy" target="_blank">{{ $t('enabled.true[0].privacyPolicy') }}</a>
          </template>
        </i18n-t>
      </label>
...
<i18n>
{
  ...
  "ja": {
    ...
    "contact": [
      "私は報告にコンタクトの情報を含みます。",
      "私たちからあなたのAGR-Collectの利用状況について問い合わせることがあります。"
    ],
    "field": {
