...
<i18n>
{
  ...
  "zh": {
    "title": "表单状态",
    "introduction": [
      "表单状态用于控制每份表单的使用周期。通常情况下，表单会从“开放”状态开始，并在不再需要时依次转为“关闭中”与“已关闭”状态（但存在例外情况）。",
      {
        "full": "{open}表单可提供下载，并可接受新的提交",
        "open": "打开"
      },
      {
        "full": "{closing}表单可接受新的提交，但{not}可下载。",
        "closing": "正在关闭",
        "not": "不"
      },
      {
        "full": "{closed}表单{not1}可提供下载，并{not2}接收新的提交。",
        "closed": "已关闭",
        "not1": "不",
        "not2": "不"
      }
