...
<i18n lang="json5">
{
  "en": {
    ...
    "introduction": [
      ...
      "There are several options for submitting data to AGR-Collect:",
      {
...
<i18n>
{
  "cs": {
    ...
    "introduction": [
      "Existuje několik možností pro odesílání dat do AGR-Collect:",
      {
  ...
  "de": {
    ...
    "introduction": [
      "Es gibt mehrere Optionen, um Daten an AGR-Collect zu übermitteln:",
      {
  ...
  "es": {
    ...
    "introduction": [
      "Hay varias opciones para enviar datos a AGR-Collect:",
      {
  ...
  "fr": {
    ...
    "introduction": [
      "Il y a plusieurs méthodes pour envoyer des données à AGR-Collect:",
      {
  ...
  "id": {
    ...
    "introduction": [
      "Ada beberapa pengaturan untuk mengirim data ke AGR-Collect:",
      {
  ...
  "it": {
    "title": "Opzioni invio",
    "introduction": [
      "Esistono diverse opzioni per inviare dati a AGR-Collect:",
      {
  ...
  "ja": {
    "title": "フォーム提出方法の選択肢",
    "introduction": [
      "AGR-Collectへのデータ提出方法にはいくつかの選択肢があります。",
      {
  ...
  "pt": {
    ...
    "introduction": [
      "Existem várias maneiras de enviar respostas para o AGR-Collect:",
      {
  ...
  "sw": {
    ...
    "introduction": [
      "Kuna chaguo kadhaa za kuwasilisha data kwa AGR-Collect:",
      {
