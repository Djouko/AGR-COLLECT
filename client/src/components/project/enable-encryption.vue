    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            ...
            "In addition, the following are true in this version of AGR-Collect:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Kromě toho platí pro tuto verzi AGR-Collect následující:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Außerdem treffen die folgenden Punkte in dieser Version von AGR-Collect zu:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Además, lo siguiente es cierto en esta versión de AGR-Collect:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "En outre, ce qui suit est vrai dans cette version d'AGR-Collect :",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Sebagai tambahan, berikut adalah yang benar ada pada versi AGR-Collect ini:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Inoltre, quanto segue è reale in questa versione di AGR-Collect:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "また、このバージョンのAGR-Collectでは以下のようになっています。",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "Além disso, as informações a seguir são verdadeiras nessa versão do AGR-Collect:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "kwa kuongeza, yafuatayo ni kweli katika toleo hili la AGR-Collect:",
            [
    ...
    "steps": [
      {
        "introduction": [
          ...
          [
            "此外，在此版本的 AGR-Collect 中，以下內容均屬正確：",
            [
              "現有提交內容將保持未加密狀態。"
            ],
            [
