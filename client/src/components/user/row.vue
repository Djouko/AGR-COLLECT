...
export default {
  ...
  emits: ['assigned-role', 'reset-password', 'suspend', 'restore', 'retire'],
  setup() {
...
<i18n lang="json5">
{
  "en": {
    ...
    // An Administrator may suspend/restore other Web Users, but not their own account.
    "cannotSuspend": "You may not suspend yourself.",
    "cannotRestore": "You may not restore yourself.",
